...
# e.g. zelynic-vX.Y.Z-linux-amd64-gnu.tar.gz
#      zelynic-vX.Y.Z-linux-amd64-gnu.tar.gz.asc
...
(e.g. `zelynic-v11.0.0-linux-amd64-gnu` or
`zelynic-v11.0.0-linux-amd64-musl`).
