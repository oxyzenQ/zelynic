...
create_archive() {
        ...
        # Copy binary (self-contained: eBPF objects embedded,
        # NIGHT-improve-1 phase 3 — nothing else to ship)
...
main() {
        ...
        cat dist/*.sha512sum | while read -r line; do
                echo "    $line"
        done
        echo
