...
Usage:
  ...
  python3 scripts/supermassive-test-v2.py --self-test  # engine smoke, no root
  sudo ./scripts/supermassive-test-v2.sh --binary ./zelynic
...
def main():
    ...
    if os.geteuid() != 0:
        ...
        return 2
    if not lib.resolve_binary(args.binary, "sudo ./scripts/supermassive-test-v2.sh"):
        return 2
