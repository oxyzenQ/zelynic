...
curl -sL https://github.com/oxyzenq/zelynic/releases/latest/download/zelynic-v2.6.0-x86_64-linux.tar.gz | tar xz

# Install system-wide
sudo install -Dm755 zelynic-v2.6.0-x86_64-linux/zelynic /usr/local/bin/zelynic
```
