...
//! docs/BRANDING.md documents. The 256/16 fallbacks favor visibility
//! over exact match (the warn-yellow precedent); the grey slot
//! degrades to the neutral grey ramp (245 / bright black 90) in
//! every theme — subordinate text stays subordinate whatever the
//! accent becomes.
//!
...
const fn table(theme: Theme, slot: Slot) -> SlotEncodings {
    match (theme, slot) {
        ...
        (Theme::Carbon, Slot::Brand) => slot!(214, 214, 214, 250, 37),
        (Theme::Carbon, Slot::Ok) => slot!(170, 255, 178, 48, 32),
        (Theme::Carbon, Slot::Warn) => slot!(245, 197, 24, 220, 33),
        #[cfg(any(feature = "ebpf", test))]
        (Theme::Carbon, Slot::Hot) => slot!(255, 77, 77, 196, 91),
        #[cfg(any(feature = "ebpf", test))]
        (Theme::Carbon, Slot::Grey) => slot!(158, 158, 158, 245, 90),
        (Theme::Atomic, Slot::Brand) => slot!(255, 109, 0, 202, 33),
        (Theme::Atomic, Slot::Ok) => slot!(0, 230, 118, 46, 32),
        (Theme::Atomic, Slot::Warn) => slot!(255, 234, 0, 226, 33),
        #[cfg(any(feature = "ebpf", test))]
        (Theme::Atomic, Slot::Hot) => slot!(255, 23, 68, 196, 91),
        #[cfg(any(feature = "ebpf", test))]
