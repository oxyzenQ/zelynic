# Changelog — v11 Era (frozen history)

This file is the frozen campaign history of zelynic's v11 development
line — the NIGHT research campaign (2026-09-17 to 2026-09-19) that
carried the project from the v10.0.0 stable release to the pure-Rust
v11 candidate at 11.0.0-dev.1. The entries below accumulated under
the live [CHANGELOG.md](CHANGELOG.md) Unreleased section and were
moved here unchanged in NIGHT-docs-1 — immutable historical record,
original order preserved, byte-identical to the pre-split blob
(verified by diff against 1026c1f).

The active changelog — [Unreleased] and every post-campaign entry —
lives in [CHANGELOG.md](CHANGELOG.md).

The format is based on Keep a Changelog, and this project adheres to
Semantic Versioning.

## The v11 Line — the NIGHT Research Campaign (2026-09-17 to 2026-09-19)
